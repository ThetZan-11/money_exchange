            ...
            <div class="col-xxl-4 col-md-6">
              <div class="card info-card sales-card">
                ...
                <?php   
                        ...
                        // }
                  ?>
                  <h5 class="card-title">Sales <span>| <?php // $sale ?></span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6><?php //$sale_count['sale_count'] ?></h6>
            ...
            <div class="col-xxl-4 col-md-6">
              ...
              <div class="card info-card customers-card">
                ...
                <?php 
                      ...
                      // } 
                    ?>
                  <h5 class="card-title">Customers <span>| <?php // $customer ?></span></h5>
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-3">
                      <h6><?php // $customer_count['customer_count'] ?></h6>
