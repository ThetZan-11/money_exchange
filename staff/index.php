              ...
              <div class="card info-card sales-card">
                ...
                <?php 
                        if(isset($_POST['month_sale'])){
                          $sale_count = total_sale_counter_month_filter($mysqli, $user_email);
                          $sale = "This Month";
                        } else if(isset($_POST['today_sale'])){
                          $sale_count = total_sale_counter_today_filter($mysqli, $user_email);
                        } else if(isset($_POST['year_sale'])){
                          $sale_count = total_sale_counter_year_filter($mysqli, $user_email);
                          $sale = "This Year";
                        } else {
                          $sale_count = total_sale_counter_today_filter($mysqli, $user_email);
                        }
              ...
              <div class="card info-card customers-card">
                ...
                <?php 
                      if(isset($_POST['month_customer'])){
                        $customer_count = customer_count_from_counter_month($mysqli, $user_email);
                        $customer = "This Month"; 
                      } else if(isset($_POST['today_customer'])){
                        $customer_count = customer_count_from_counter_today($mysqli, $user_email);
                      } else if(isset($_POST['year_customer'])){
                        $customer_count = customer_count_from_counter_year($mysqli, $user_email);
                        $customer = "This Year";
                      } else {
                        $customer_count = customer_count_from_counter_today($mysqli, $user_email);
                      } 
